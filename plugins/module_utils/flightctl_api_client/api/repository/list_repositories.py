...
from ...models.repository_list import RepositoryList
...
) -> Optional[Union[Error, RepositoryList]]:
    if response.status_code == 200:
        response_200 = RepositoryList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, RepositoryList]]:
    return Response(
