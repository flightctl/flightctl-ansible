...
T = TypeVar("T", bound="DeviceSpecContainers")


@_attrs_define
class DeviceSpecContainers:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        device_spec_containers = cls(
            match_patterns=match_patterns,
        )

        device_spec_containers.additional_properties = d
        return device_spec_containers
