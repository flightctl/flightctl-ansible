...
T = TypeVar("T", bound="CustomResourceMonitorSpec")


@_attrs_define
class CustomResourceMonitorSpec:
    """
    Attributes:
        monitor_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_resource_monitor_spec = cls(
            monitor_type=monitor_type,
            alert_rules=alert_rules,
            sampling_interval=sampling_interval,
        )

        custom_resource_monitor_spec.additional_properties = d
        return custom_resource_monitor_spec
