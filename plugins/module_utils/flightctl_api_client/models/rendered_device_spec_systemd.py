...
T = TypeVar("T", bound="RenderedDeviceSpecSystemd")


@_attrs_define
class RenderedDeviceSpecSystemd:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rendered_device_spec_systemd = cls(
            match_patterns=match_patterns,
        )

        rendered_device_spec_systemd.additional_properties = d
        return rendered_device_spec_systemd
