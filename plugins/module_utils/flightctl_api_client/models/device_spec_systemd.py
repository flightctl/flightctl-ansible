...
T = TypeVar("T", bound="DeviceSpecSystemd")


@_attrs_define
class DeviceSpecSystemd:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        device_spec_systemd = cls(
            match_patterns=match_patterns,
        )

        device_spec_systemd.additional_properties = d
        return device_spec_systemd
