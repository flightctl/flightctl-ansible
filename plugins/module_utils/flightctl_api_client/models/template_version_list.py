...
T = TypeVar("T", bound="TemplateVersionList")
...
class TemplateVersionList:
    ...
    Attributes:
        ...
        items (List['TemplateVersion']): List of TemplateVersions.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = TemplateVersion.from_dict(items_item_data)

            items.append(items_item)

        template_version_list = cls(
        ...
        template_version_list.additional_properties = d
        return template_version_list
