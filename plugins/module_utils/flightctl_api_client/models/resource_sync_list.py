...
T = TypeVar("T", bound="ResourceSyncList")


@_attrs_define
class ResourceSyncList:
    """
    Attributes:
        ...
        items (List['ResourceSync']): List of resourcesync.
    """

    api_version: str
    kind: str
    metadata: "ListMeta"
    items: List["ResourceSync"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ResourceSync.from_dict(items_item_data)

            items.append(items_item)

        resource_sync_list = cls(
        ...
        resource_sync_list.additional_properties = d
        return resource_sync_list
