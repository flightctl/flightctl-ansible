...
T = TypeVar("T", bound="ApplicationsSummaryStatus")


@_attrs_define
class ApplicationsSummaryStatus:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        applications_summary_status = cls(
            status=status,
            info=info,
        )

        applications_summary_status.additional_properties = d
        return applications_summary_status
