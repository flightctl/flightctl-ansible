...
T = TypeVar("T", bound="DiskResourceMonitorSpec")


@_attrs_define
class DiskResourceMonitorSpec:
    """
    Attributes:
        monitor_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        disk_resource_monitor_spec = cls(
        ...
        disk_resource_monitor_spec.additional_properties = d
        return disk_resource_monitor_spec
