...
T = TypeVar("T", bound="CertificateSigningRequestList")
...
class CertificateSigningRequestList:
    ...
    Attributes:
        ...
        items (List['CertificateSigningRequest']): List of CertificateSigningRequest.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CertificateSigningRequest.from_dict(items_item_data)

            items.append(items_item)

        certificate_signing_request_list = cls(
        ...
        certificate_signing_request_list.additional_properties = d
        return certificate_signing_request_list
