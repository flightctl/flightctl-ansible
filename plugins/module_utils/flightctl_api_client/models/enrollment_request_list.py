...
T = TypeVar("T", bound="EnrollmentRequestList")


@_attrs_define
class EnrollmentRequestList:
    ...
    Attributes:
        ...
        items (List['EnrollmentRequest']): List of EnrollmentRequest.
    """

    api_version: str
    kind: str
    metadata: "ListMeta"
    items: List["EnrollmentRequest"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = EnrollmentRequest.from_dict(items_item_data)

            items.append(items_item)

        enrollment_request_list = cls(
        ...
        enrollment_request_list.additional_properties = d
        return enrollment_request_list
