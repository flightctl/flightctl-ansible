...
class CertificateSigningRequestStatus(BaseModel):
    ...
    """ # noqa: E501
    certificate: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="The issued signed certificate, immutable once populated")
    conditions: List[Condition] = Field(description="Conditions applied to the request. Known conditions are Approved, Denied, and Failed")
