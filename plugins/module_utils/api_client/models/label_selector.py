...
class LabelSelector(BaseModel):
    ...
    match_expressions: Optional[Annotated[List[MatchExpression], Field(min_length=1)]] = Field(default=None, alias="matchExpressions")
    __properties: ClassVar[List[str]] = ["matchLabels", "matchExpressions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchExpressions": [MatchExpression.from_dict(_item) for _item in obj["matchExpressions"]] if obj.get("matchExpressions") is not None else None
        })
        return _obj
