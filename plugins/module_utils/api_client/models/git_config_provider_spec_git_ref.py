...
class GitConfigProviderSpecGitRef(BaseModel):
    """
    ...
    target_revision: StrictStr = Field(alias="targetRevision")
    path: StrictStr
    mount_path: Optional[StrictStr] = Field(default='/', description="Path to config in device", alias="mountPath")
    __properties: ClassVar[List[str]] = ["repository", "targetRevision", "path", "mountPath"]
