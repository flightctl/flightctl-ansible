...
class DiskResourceMonitorSpec(BaseModel):
    """
    ...
    path: StrictStr = Field(description="The directory path to monitor for disk usage.")
    __properties: ClassVar[List[str]] = ["monitorType", "alertRules", "samplingInterval", "path"]
