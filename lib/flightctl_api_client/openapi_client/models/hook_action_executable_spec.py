...
class HookActionExecutableSpec(BaseModel):
    """
    ...
    env_vars: Optional[List[StrictStr]] = Field(default=None, description="An optional list of KEY=VALUE pairs to set as environment variables for the executable.", alias="envVars")
    ...
    __properties: ClassVar[List[str]] = ["timeout", "run", "envVars", "workDir"]
