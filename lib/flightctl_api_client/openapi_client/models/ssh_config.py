...
class SshConfig(BaseModel):
    ...
    SshConfig
    """ # noqa: E501
    ssh_private_key: Optional[SecretStr] = Field(default=None, description="Base64 encoded private SSH key", alias="sshPrivateKey")
    private_key_passphrase: Optional[SecretStr] = Field(default=None, description="The passphrase for sshPrivateKey", alias="privateKeyPassphrase")
    ...
    __properties: ClassVar[List[str]] = ["sshPrivateKey", "privateKeyPassphrase", "skipServerVerification"]
